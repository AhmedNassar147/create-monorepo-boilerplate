...
const PAGES_DATA_IN_APP_FOLDER = [
  {
    path: "pmiQuickRegistration",
    pageIndexPath: "../components/PmiQuickRegistration"
  },
  {
    path: "pmiRegistration",
    pageIndexPath: "../components/PmiRegistration"
  },
  {
    path: "pmiSearch",
    pageIndexPath: "../components/PmiSearch"
  },
  {
    path: "patientBooking",
    pageIndexPath: "../components/PatientBooking"
  },
  {
    path: "contractSearch",
    pageIndexPath: "../components/ContractSearch"
  },
  {
    path: "staffMaster",
  ...
  {
    path: "patientBillingInvoiceQuery",
    pageIndexPath: "../Pages/PatientBillingInvoiceQuery"
  },
  {
  ...
  {
    path: "opticsPos",
    pageIndexPath: "../Pages/OpticsPatientVisits"
  },
  {
    path: "generalDesktop",
  ...
  {
    path: "creditPatientInvoiceSummary",
    pageIndexPath: "../Pages/CreditPatientInvoiceSummary"
  },
  {
    path: "createDhsDraft",
  ...
  {
    path: "receptionInvoiceQuery",
    pageIndexPath: "../Pages/ReceptionInvoiceQuery"
  },
  {
  ...
  {
    path: "admissionFinancialBalance",
    pageIndexPath: "../Pages/AdmissionFinancialBalance"
  },
  {
  ...
  {
    path: "doctorServicesVolume",
    pageIndexPath: "../Pages/DoctorServicesVolume"
  },
  {
    path: "miTicketQuery",
  ...
  {
    path: "labels",
    pageIndexPath: "../Pages/LabelsPage"
  }
];
